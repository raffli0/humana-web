...
export default function ShiftManagement() {
    const { shifts, employees, shiftSwaps, loading, createShift, updateShift, deleteShift, assignShift, updateSwapStatus } = useShiftViewModel();
    ...
    return (
        <main className="min-h-screen bg-slate-50/50 p-6 md:p-8 space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">Manajemen Shift</h1>
                    <p className="text-muted-foreground mt-1">Atur dan tetapkan jadwal kerja untuk tim Anda.</p>
                </div>
                ...
                <Tabs defaultValue="schedule" className="w-full">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div className="lg:col-span-2 space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {shifts.map((shift) => (
                                        <Card key={shift.id} className="overflow-hidden border-none shadow-sm ring-1 ring-gray-200 hover:shadow-md transition-all duration-200 group">
                                            <CardHeader className="pb-2 bg-white">
                                                ...
                                                <CardDescription className="flex items-center gap-2 font-medium">
                                                    <Badge variant="secondary" className="bg-indigo-50 text-indigo-700 font-mono border border-indigo-100">
                                                ...
                                                {shift.late_tolerance_minutes !== undefined && shift.late_tolerance_minutes > 0 && (
                                                    <div className="flex items-center text-xs text-amber-600 mt-2 font-medium">
                                                        ...
                                                        Toleransi keterlambatan {shift.late_tolerance_minutes} menit
                                                    </div>
                                                )}
                                            </CardHeader>
                            ...
                            <div className="space-y-6">
                                <Card className="border-none shadow-sm ring-1 ring-gray-200 bg-white sticky top-6">
                    ...
                    <TabsContent value="requests">
                        <Card className="border-none shadow-sm ring-1 ring-gray-200">
                            <CardHeader>
                                <CardTitle>Permintaan Pertukaran Shift</CardTitle>
                                <CardDescription>Kelola permintaan tukar shift dari karyawan.</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <ShiftSwapList
                                    swaps={shiftSwaps}
                        ...
                        <div className="max-h-[300px] overflow-y-auto space-y-2 pr-2">
                            {filteredEmployees.map((employee) => (
                                <div key={employee.id} className={cn(
                                    ...
                                    employee.shift_id === selectedShift?.id ? "bg-indigo-50/50 border-indigo-100" : "border-slate-100 hover:bg-slate-50"
                                )}>
                                    <div className="flex items-center gap-3">
                                    ...
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            employee.shift_id === selectedShift?.id && "bg-indigo-50 text-indigo-700 ring-1 ring-indigo-200 hover:bg-indigo-100 hover:text-indigo-800"
                                        )}
